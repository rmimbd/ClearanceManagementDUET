...
<body>
	...
	<div class="main" style="vertical-align:center">
		...
		$index=0;
		$admin_office_data=mysqli_fetch_array($DB->get_application_admin_office_data_of_student($DB->current_user->student_id));
		...
		<div class="compactbox">
			<div class="hidableBox">
				<div id="initialApprovalTitle" class="hidableBoxTitle">
		...
		<br>
		<?php if($application_data['final_status']==1){?>
		<center><a href="clearance_application_downloader.php"><button class="button2"><i class="fa fa-download"></i> Download Clearance Certificate</button></a></center>
		<?php } else echo "<br><br>"; ?>
		<br>
		<?php }
		else{?>
		<div class="col-2" style="float:none; display: block;">
			<div class="box">
				...
				<div class="boxContent">
					You did not submit any clearance application. Click the apply button to submit an application.<br><br>
					<center><a href="apply_for_clearance.php"><button class="button2 greenButton">Apply</button></a></center>
				</div>
			</div>
		</div>
		<?php } ?>
