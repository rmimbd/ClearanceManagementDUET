<?php
	...
	$laba_data=$DB->get_all_information_of_lab($lab_id);
	$_SESSION['updating_lab_id']=$lab_id;
?>
	...
	<form class="createReportForm"   method="POST" action="lab_add_update_server.php">
		...
		<div class="formEvenRow">
			...
			<div class="formElement">
				<input type="text" minlength="0" maxlength="0" placeholder="<?php echo $lab_id; ?>" disabled>
			</div>
		</div>
		<div class="formOddRow">
			...
			<div class="formElement">
				<input type="text" name="lab_name" minlength="6" placeholder="Name of the Lab" value="<?php if(isset($_SESSION['au_old_value'])) echo $_SESSION['au_old_value']['lab_name']; else echo $laba_data['name'] ?>" required>
			</div>
		...
		<div class="formEvenRow">
			...
			<div class="formElement">
				 <select name="department_id" required>
				 	...
				 	<option value="<?php echo $department['department_id']; ?>" <?php if(isset($_SESSION['au_old_value'])){if ($_SESSION['au_old_value']['department_id']==$department['department_id']) echo "selected";}else if($laba_data['department']==$department['department_id']) echo "selected";?>><?php echo $department['department_name']; ?></option>
				 	<?php } ?>
				 </select>
			</div>
		...
		<div class="formOddRow">
			...
			<div class="formElement">
				<input type="text" name="lab_assistant" minlength="5" maxlength="5" placeholder="Lab Assistant User ID" value="<?php if(isset($_SESSION['au_old_value'])) echo $_SESSION['au_old_value']['lab_assistant']; else echo $laba_data['assistant'];?>" >
			</div>
		...
		<div class="formEvenRow">
			...
			<div class="formElement">
				<input type="text" name="lab_incharge" minlength="5" maxlength="5" placeholder="Lab In Charge User ID" value="<?php if(isset($_SESSION['au_old_value'])) echo $_SESSION['au_old_value']['lab_incharge'];  else echo $laba_data['officer'];?>" >
			</div>
		...
		<div class="formOddRow">
			<button type="submit" class="button1" name="update_lab_data">Update</button>
		</div>
