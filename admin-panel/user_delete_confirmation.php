<?php
	...
	$_SESSION['deleting_user_id']=$user_id;
?>
...
<br>
<center>
	<h3>Are you sure to Restrict this user?</h3>
	<form method="POST" action="user_add_update_server.php">
		...
		<button type="submit" class="button2 redButton" name="delete_user">
			<i class="fa fa-ban"></i> Yes, Restrict
		</button>
	</form>
</center>