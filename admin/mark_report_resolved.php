...
<div class="tabBox">
	...
	if(isset($_GET['report_id'])){
		...
		?>
	<form class="createReportForm"  method="POST" action="mark_report_resolved_server.php">
		...
		<div class="formOddRow">
			<center>
			<strong><br>Are you sure to mark this report resolved?<br></strong>
			<br>
			<button type="submit" class="button2 greenButton" name="mark_resolve_report">Resolve</button> 
			<a href="../admin/?tab=browseReport"><button type="button" class="button2 redButton">Cancel</button></a>
			</center>
		</div>
	</form>
	<?php
				...
				echo "<br><br><center><p class=\"unsuccessMessage\">This report is already resolved.</p></center><br><br>";
			}
		}
		else
